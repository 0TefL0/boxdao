...
var T = {
  ru: {
    ...
    nft_stats:      '3 всего · 1 свободна · 2 в стейкинге',
    nft_st_free:    'СВОБОДНА',
    nft_act_stake:  'Стейкинг',
    nft_rate:       'Ставка',
    nft_unlock:     'Разблокировка',
    nft_earned:     'Начислено',
    nft_lock_progress: 'Прогресс блокировки',
    nft_level:      'Уровень',
    nft_lvl_base:   'Базовый',
    nft_to_next:    'До',
    nft_lvl_advanced: 'Продвинутого',
    nft_days:       'дн',
    ana_revenue_total: 'Всего выручка',
    ana_today:         'Сегодня',
    ana_sold:          'Продано',
    ana_uptime:        'Аптайм',
    ana_per_month:     'за месяц',
    ana_vs_yesterday:  'vs вчера',
    ana_boxes:         'боксов',
    ana_last30:        'за 30 дней',
    ana_revenue_dyn:   'Динамика выручки',
    ana_last30d:       'последние 30 дней',
    ana_recent_tx:     'Последние операции',
    ana_tx_sale:       'Продажа Lucky Box',
    ana_tx_refill:     'Пополнение товара',
    ana_machine_info:  'Информация об автомате',
    ana_serial:        'Серийный №',
    ana_collection:    'Коллекция',
    ana_city:          'Город',
    ana_address:       'Адрес',
    ana_installed:     'Установлен',
    ana_status:        'Статус',
    ana_online:        'Онлайн',
    ana_holders:       'Холдеров NFT',
    ana_capacity:      'Заполненность',
    nft_no_match:      'Нет NFT по этому фильтру',
    hist_sub:          'Все начисления GEM',
    hist_total:        'Всего начислено',
    hist_month:        'За месяц',
  ...
  en: {
    ...
    nft_stats:      '3 total · 1 free · 2 staked',
    nft_st_free:    'FREE',
    nft_act_stake:  'Stake',
    nft_rate:       'Rate',
    nft_unlock:     'Unlock',
    nft_earned:     'Earned',
    nft_lock_progress: 'Lock progress',
    nft_level:      'Level',
    nft_lvl_base:   'Basic',
    nft_to_next:    'To',
    nft_lvl_advanced: 'Advanced',
    nft_days:       'd',
    ana_revenue_total: 'Total revenue',
    ana_today:         'Today',
    ana_sold:          'Sold',
    ana_uptime:        'Uptime',
    ana_per_month:     'this month',
    ana_vs_yesterday:  'vs yesterday',
    ana_boxes:         'boxes',
    ana_last30:        'last 30 days',
    ana_revenue_dyn:   'Revenue trend',
    ana_last30d:       'last 30 days',
    ana_recent_tx:     'Recent activity',
    ana_tx_sale:       'Lucky Box sale',
    ana_tx_refill:     'Stock refill',
    ana_machine_info:  'Machine info',
    ana_serial:        'Serial №',
    ana_collection:    'Collection',
    ana_city:          'City',
    ana_address:       'Address',
    ana_installed:     'Installed',
    ana_status:        'Status',
    ana_online:        'Online',
    ana_holders:       'NFT holders',
    ana_capacity:      'Stock level',
    nft_no_match:      'No NFTs match this filter',
    hist_sub:          'All GEM earnings',
    hist_total:        'Total earned',
